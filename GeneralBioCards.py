...
def BioCards(): 
    ...
    new_card_list = FlashCardBank.bio_cards.copy() # making a copy of the list, so that everytime the test is finished, no data will be lost
