...
File: GeneralChemCards.py
Date Completed: March 5rd, 2023
executed in the Main.py file, used if user inputs 'b' into terminal.
"""
...
def ChemCards():
    ...
    input("You have choosen the General Chemistry flash cards\n(please input anything in the terminal to continue):")
    ...
    new_card_list = FlashCardBank.chem_cards.copy() # making a copy of the list, so that everytime the test is finished, no data will be lost
